...
/*-------------- Variables mises en cache ----------*/

// analyse les pieceId et renvoie l'index de la place de cette pièce sur le tableau
...
// propriétés de la pièce sélectionnée
let selectedPiece = {
    pieceId: -1,
    indexOfBoardPiece: -1,
    isKing: false,
...
// initialise Event Listeners sur les morceaux
...
// contient la longueur du nombre de pièces du joueur
...
// supprime les mouvements possibles de l'ancienne pièce sélectionnée (* ceci est nécessaire car l'utilisateur pourrait resélectionner une pièce *)
...
// réinitialise les bordures par défaut
...
// réinitialise les propriétés de la pièce sélectionnée
...
// obtient l'ID et l'index de la cellule du tableau sur laquelle elle est activée
...
// vérifie si la pièce sélectionnée est un roi
...
// récupère les mouvements que la pièce sélectionnée peut effectuer
...
// récupère les mouvements que la pièce sélectionnée peut sauter
...
// restreint le mouvement si la pièce est un roi
...
// donne à la pièce une surbrillance verte pour l'utilisateur (montrant son mobile)
...
// donne aux cellules du tableau un 'clic' basé sur les mouvements possibles
...
/* v lorsque l'on clique sur la cellule v */

// effectue le mouvement sur lequel on a cliqué
...
// Modifie les données d'état de la carte sur le back-end
...
// supprime event listnner 'onClick' pour les pièces
